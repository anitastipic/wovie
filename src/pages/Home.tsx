    ...
    return (
        <>
            <div className="overflow-x-clip scroll-smooth">
                <div className="z-10 h-[200vh] w-full relative top-[18vh] left-[0vw]">
                    <div className="h-[100vh] w-full fixed">
                        <div id="scrollContainer"
                             className="h-[30vh] w-[80vw] sm:h-[40vh] sm:w-[40vw] absolute top-[25vh] left-[10vw] sm:top-[20vh] sm:left-[50vw]">
                            <img
                ...
                <div
                    className="h-[87vh] w-full bg-white absolute top-[220vh] z-10 flex flex-col justify-center items-center text-center">
